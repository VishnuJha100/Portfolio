        ...
        <div className='max-w-7xl mx-auto flex h-14 items-center'>
            <div className='md:mr-4 flex justify-between w-full'>
                <a href="#" className='mr-6 flex items-center space-x-2'>
                    <img src={assets.logo_icon} alt="" className='w-40' />
                </a>
                <nav className='md:flex hidden items-center space-x-6 text-lg font-medium'>
                    ...
                    <a href="#conttact" className='transition-colors hover:text-foreground/80 text-foreground/60'>Contact</a>
                </nav>
            </div>
        ...
        {mobileMenuOpen && (
            <div className='md:hidden'>
                <div className='space-y-1 px-2 pb-3 pt-2'>
                    ...
                    <a href="#project" className='block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900'>Project</a>
                    ...
                    <a href="#contact" className='block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900'>Conact</a>
                </div>
            </div>        )}
    </header>
  )
